...
public class ShowImage1 extends javax.swing.JDialog {

    /**
     * Creates new form ShowImage
     */
    public ShowImage1(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    }
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                ShowImage dialog = new ShowImage((Client) new javax.swing.JFrame(), true);
